...
public class notify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTime = (TextView) findViewById(R.id.tvvv);

        reminderSwitch = (SwitchCompat) findViewById(R.id.timerSwitch);

        hour = localData.get_hour();
        min = localData.get_min();
System.out.println(getFormatedTime(hour, min));
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    NotificationScheduler.setReminder(notify.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    NotificationScheduler.cancelReminder(notify.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
    ...
    private void showTimePickerDialog(int h, int m) {
        ...
        TimePickerDialog builder = new TimePickerDialog(this, R.style.DialogThemes,
